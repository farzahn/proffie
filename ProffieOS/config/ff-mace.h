...
Preset presets[] = {
{ "MACE;common",  "font/font1.wav",
/* copyright Fett263 Baylan Skoll (Primary Blade) OS7 Style
https://www.fett263.com/fett263-proffieOS7-style-library.html#Baylan Skoll
OS7.14 v2.242p
Single Style
Base Style: Baylan Skoll
...
/*
 add to preset as StylePtr<MACE_CRYSTAL>()
*/
...
/*
 add to preset as StylePtr<MACE_HEART>()
*/
